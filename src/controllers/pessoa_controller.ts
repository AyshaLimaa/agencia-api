...
import { AddPessoaService } from '../services/pessoas/add_pessoas_services'
import { UpdatePessoaService } from '../services/pessoas/update_pessoas_services'
import { BuscarPessoasService } from '../services/pessoas/buscar_pessoas_services'
import { ListarPessoaService } from '../services/usuarios/listar_pessoas_services'
...
export class PessoaController {
  async salvarPessoa (request: Request, reponse: Response): Promise<Response> {
    ...
    await addPessoasService.add(nome, email, cpf)
